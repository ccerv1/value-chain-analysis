...
1. [Coffee 101](#1-coffee-101)
2. [The Global Coffee Market](#2-the-global-coffee-market)
3. [The VCA Framework](#3-the-vca-framework)
4. [From Analysis to Action](#4-from-analysis-to-action)
5. [Practical Advice for Fieldwork](#5-practical-advice-for-fieldwork)
6. [Open Questions in Coffee](#6-open-questions-in-coffee)
...
- **Washed vs. natural (unwashed) channels** — these often involve different actors and different economics
- **Cooperative vs. private channels** — cooperatives aggregate smallholder production and may capture processing margins that would otherwise go to private intermediaries
- **Export vs. domestic channels** — different quality standards, different pricing, different actors
...
1. **Currency** — local currency to USD
2. **Weight** — local units to standard units (kg to lb, or vice versa)
3. **Product form** — cherry to green (or parchment to green)

Here is a worked example from Rwanda:

> **Starting points:**
> - Export price = $2.23/lb green
> - Farmer price = 500 RWF/kg cherry
>
> **Step 1: Convert currency**
> (500 RWF/kg cherry) x (0.00076 USD/RWF) = $0.38/kg cherry
>
> **Step 2: Convert weight**
> ($0.38/kg cherry) x (0.45 kg/lb) = $0.17/lb cherry
>
