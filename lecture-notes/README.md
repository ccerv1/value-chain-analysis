...
6. **Open Questions** — Unresolved debates in coffee: How many farms exist? Is EUDR implementable? What does the future hold?

### Relationship to Other Materials

- The **Skills Guides** break out each analytical skill into its own standalone document with practice exercises
- The **Case Studies** apply the framework to specific countries
- The **Lecture Slides** are the visual presentation; these notes are the written companion
