...
The precise answer depends on the country, the buyer, and all the value chain steps in between. But the farmer's share of the retail cup price has stayed between 1-2% for as long as I have been measuring it. The absolute prices move. The structural ratio barely budges.

Why? And what, if anything, can be done about it?

Today you will learn not just how to answer questions like this yourself, but a framework for doing much more.

## This year's example: Ethiopian cherry to a Columbia campus cup

An Ethiopian farmer picks coffee cherry from her trees and sells it at the local market. That cherry is processed, exported, roasted, and brewed into a pour-over at a specialty cafe near Columbia's campus.
